  ...
  createPlaceholderIcons(iconsDir, missingIcons) {
    ...
    const svgIcon = `
      <svg width="128" height="128" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="8" y="8" width="112" height="112" rx="16" fill="url(#grad1)" stroke="#fff" stroke-width="4"/>
        <text x="64" y="75" text-anchor="middle" fill="white" font-family="Arial" font-size="24" font-weight="bold">E</text>
      </svg>
    `;
