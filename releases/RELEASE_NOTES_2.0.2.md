# Release Notes - FitGirl Repacks Watchlist v2.0.2
...
- Recommended: `fitgirl-watchlist-2.0.2-<TIMESTAMP>-native-installers.zip`
  - Double-click HTML installer (Chrome/Edge or Firefox) and follow prompts
- Script-based: `fitgirl-watchlist-2.0.2-<TIMESTAMP>-installers.zip`
  - Run the installer for your OS (`.bat`, `.ps1`, or `.sh`)
- Chrome manual: `fitgirl-watchlist-2.0.2-<TIMESTAMP>-chrome.zip`
  - Use chrome://extensions → Developer mode → Load unpacked → `chrome/`
- Firefox manual: `fitgirl-watchlist-2.0.2-<TIMESTAMP>-firefox.xpi`
  - Use about:debugging → This Firefox → Load Temporary Add-on → pick `manifest.json`
- Everything: `fitgirl-watchlist-2.0.2-<TIMESTAMP>-complete.zip`
...
**Thank you for using FitGirl Repacks Watchlist! 🎮**
