# Release Notes - FitGirl Repacks Watchlist v2.0.7
...
- **Chrome**: `fitgirl-watchlist-2.0.7-<TIMESTAMP>-chrome.zip`
- **Edge**: `fitgirl-watchlist-2.0.7-<TIMESTAMP>-edge.zip`
- **Safari**: `fitgirl-watchlist-2.0.7-<TIMESTAMP>-safari.zip`
- **Firefox**: `fitgirl-watchlist-2.0.7-<TIMESTAMP>-firefox.xpi`
