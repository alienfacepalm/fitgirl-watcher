# Release Notes - FitGirl Repacks Watchlist v2.0.8
...
- **Chrome**: `fitgirl-watchlist-2.0.8-<TIMESTAMP>-chrome.zip`
- **Edge**: `fitgirl-watchlist-2.0.8-<TIMESTAMP>-edge.zip`
- **Safari**: `fitgirl-watchlist-2.0.8-<TIMESTAMP>-safari.zip`
- **Firefox**: `fitgirl-watchlist-2.0.8-<TIMESTAMP>-firefox.xpi`
